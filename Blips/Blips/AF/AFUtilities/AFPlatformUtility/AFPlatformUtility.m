...
@implementation AFPlatformUtility
...
+ (NSString *)platformString {
    NSString *platform = [AFPlatformUtility platform];
...
+ (BOOL)isSupported:(NSArray *)blacklist {
    ...
    dispatch_once(&onceToken, ^{
        for (NSString* platform in blacklist) {
            if ([platform isEqualToString:[AFPlatformUtility platform]]) {
                supported = NO;
                break;
            }
        }
